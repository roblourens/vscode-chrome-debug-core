...
export class BreakpointsLogic {
    ...
    private readonly _bpsWhileLoadingLogic: BPsWhileLoadingLogic;
    ...
    public async setBreakpoints(requestedBPs: BPRecipiesInUnbindedSource, _?: ITelemetryPropertyCollector): Promise<IBPRecipieStatus[]> {
        ...
        await requestedBPsToAdd.tryGettingBPsInLoadedSource(
            ...
            () => {
                ...
                const requestedBPsPendingToAdd = new BPRecipiesInUnbindedSource(bpsDelta.resource, bpsDelta.requestedToAdd.concat(existingUnbindedBPs));
    ...
    constructor(private readonly _dependencies: BreakpointsLogicDependencies) {
        ...
        this._bpsWhileLoadingLogic = new BPsWhileLoadingLogic(internalDependencies, this._breakpointRegistry);
