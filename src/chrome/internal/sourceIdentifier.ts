...
abstract class IsSameSourceCommonLogic implements ISourceIdentifier {
...
export class SourceIdentifiedByPath extends IsSameSourceCommonLogic implements ISourceIdentifier {
...
export class SourceIdentifiedByLoadedSource extends IsSameSourceCommonLogic implements ISourceIdentifier {
