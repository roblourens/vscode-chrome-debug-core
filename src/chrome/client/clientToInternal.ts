...
import { ZeroBasedLocation, LocationInUnbindedSource } from '../internal/locations/locationInResource';
...
export class ClientToInternal {
    ...
    public toBPRecipies(args: DebugProtocol.SetBreakpointsArguments): BPRecipiesInUnbindedSource {
    ...
    public toBPRecipie(source: ISourceResolver, clientBreakpoint: DebugProtocol.SourceBreakpoint): BPRecipieInUnbindedSource {
