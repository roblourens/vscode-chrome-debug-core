...
export abstract class UnconnectedCDACommonLogic implements ChromeDebugAdapterState {
    ...
    public initialize(_args: DebugProtocol.InitializeRequestArguments, _telemetryPropertyCollector?: ITelemetryPropertyCollector, _requestSeq?: number): Promise<DebugProtocol.Capabilities> {
        return this.throwNotConnectedError();
    }
