...
import { TerminatedEvent, ContinuedEvent, Logger, logger } from 'vscode-debugadapter';
...
export class ChromeDebugLogic {
    ...
    private readonly _runtimeScriptsManager: CDTPScriptsRegistry;
    ...
    public constructor(lineColTransformer: LineColTransformer, sourceMapTransformer: BaseSourceMapTransformer, pathTransformer: BasePathTransformer,
        session: ISession, runtimeScriptsManager: CDTPScriptsRegistry, chromeConnection: ChromeConnection,
