...
export class ScopeContainer extends BaseVariableContainer {
    ...
    private _frameId: CallFrame<ScriptOrSource>;
    private _origScopeIndex: number;

    public constructor(frameId: CallFrame<ScriptOrSource>, origScopeIndex: number, objectId: string, thisObj?: Crdp.Runtime.RemoteObject, returnValue?: Crdp.Runtime.RemoteObject) {
        super(objectId, '');
