...
const _debugger = {
    ...
    // Requests
    GetScriptSource: new RequestChannelIdentifier<IScript, string>(),
...
const _schema = {
    GetDomains: new RequestChannelIdentifier<void, Crdp.Schema.Domain[]>(),
};

const Debugger: Readonly<typeof _debugger> = _debugger;

const Schema: Readonly<typeof _schema> = _schema;
