...
import { LocationInScript, ZeroBasedLocation, ScriptOrSourceOrIdentifierOrUrlRegexp } from '../internal/locations/locationInResource';
...
export class TargetToInternal {
    ...
    constructor(
        private readonly _scriptsRegistry: ScriptsRegistry,
