...
import { BreakpointRecipieInUrl, BreakpointRecipieInScript, BPRecipie, BreakpointRecipieInUrlRegexp, URLRegexp, IBPRecipie } from '../internal/breakpoints/bpRecipie';
...
export class TargetToInternal {
    ...
    public async toBreakpointInScript(bpRecipie: BreakpointRecipieInScript, params: Crdp.Debugger.SetBreakpointResponse): Promise<BreakpointInScript> {
        return this.toBreakpoinInResource<IScript>(BreakpointInScript, bpRecipie, params.actualLocation);
    }

    public async toBreakpointInUrl(bpRecipie: BreakpointRecipieInUrl, actualLocation: Crdp.Debugger.Location): Promise<BreakpointInUrl> {
        return this.toBreakpoinInResource<IResourceIdentifier>(BreakpointInUrl, bpRecipie, actualLocation);
    }

    public async toBreakpointInUrlRegexp(bpRecipie: BreakpointRecipieInUrlRegexp, actualLocation: Crdp.Debugger.Location): Promise<BreakpointInUrlRegexp> {
