...
export class PausedEvent {
    public cloneButWithHitBreakpoints(hitBreakpoints: IBPRecipie<ScriptOrSourceOrURLOrURLRegexp>[]): PausedEvent {
    ...
    constructor(
        ...
        public readonly hitBreakpoints?: IBPRecipie<ScriptOrSourceOrURLOrURLRegexp>[], // TODO DIEGO: Make this readonly
