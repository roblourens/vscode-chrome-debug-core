...
import { IURL } from '../internal/sources/resourceIdentifier';
import { IBPRecipie } from '../internal/breakpoints/bpRecipie';
import { IBreakpoint } from '../internal/breakpoints/breakpoint';

export type integer = number;
export type CDTPSupportedResources = IScript | IURL<CDTPScriptUrl> | URLRegexp;
...
export type CDTPBreakpoint = IBreakpoint<CDTPSupportedResources>;
