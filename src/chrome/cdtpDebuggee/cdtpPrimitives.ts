...
import { IMappedBPRecipie } from '../internal/breakpoints/baseMappedBPRecipie';
...
export type CDTPBPRecipie = IMappedBPRecipie<CDTPSupportedResources, CDTPSupportedHitActions>;
